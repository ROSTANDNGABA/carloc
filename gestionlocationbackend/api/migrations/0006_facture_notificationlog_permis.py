        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type_facture', models.CharField(
                    choices=[('location', 'Facture de location'), ('acompte', "Facture d'acompte")],
                    default='location',
                    max_length=20,
                )),
                ('date_emission', models.DateTimeField(auto_now_add=True)),
                ('montant_location', models.DecimalField(decimal_places=2, default=0, max_digits=12)),
                ('montant_penalites', models.DecimalField(decimal_places=2, default=0, max_digits=12)),
