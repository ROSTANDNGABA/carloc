    ...
    def handle(self, *args, **options):
        ...
        try:
            ...
            if provider == "emailjs":
                ...
                if not ok:
                    raise RuntimeError(
                        "EmailJS a refuse ou echoue l envoi. Consultez NotificationLog.erreur."
                    )
            else:
            ...
            self.stdout.write(
                self.style.SUCCESS(f"E-mail envoye avec succes vers {destinataire}.")
            )
            ...
            self.stdout.write(
                "  EMAILJS_TEMPLATE_ID ou EMAILJS_TEMPLATE_RESERVATION_ID"
            )
